  ...
  return (
    <section className="relative overflow-hidden pt-28 pb-16 sm:pt-36 sm:pb-24">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 opacity-40 [background:linear-gradient(to_right,#d4d4d4_1px,transparent_1px),linear-gradient(to_bottom,#d4d4d4_1px,transparent_1px)] [background-size:28px_28px] dark:opacity-20" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-sm sm:text-base text-neutral-600 dark:text-neutral-400 leading-relaxed">
          Pilihan perangkat rumah, komputasi, dan audio dengan tampilan bersih, pengiriman
          cepat, serta harga kompetitif untuk kebutuhan harian Anda.
        </p>
